...
from ltr.dataset.ardataset import Lasot, MSCOCOSeq, ImagenetVID, ImagenetDET, Youtube_VOS
from ltr.data.ardata import SEprocessing, SEsampler, LTRLoader
import ltr.data.ardata.transforms as dltransforms
from ltr import actors
from ltr.trainers import LTRTrainer
import ltr.models.ar_legacy.SE_other.SEm_r34 as SEx
...
def run(settings):
    ...
    # Create network
    net = SEx.SEm_resnet34(backbone_pretrained=True,
    ...
    actor = actors.SEm_Actor(net=net, objective=objective)
