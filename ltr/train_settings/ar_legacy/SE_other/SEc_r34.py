...
def run(settings):
    ...
    # devtool.node_buffer.settings = settings
    ...
    dataset_train = SEsampler.SEMaskSampler([lasot_train,got_10k_train,coco_train],
                                        [1,1,1],
    ...
    # Create network
    net = SEx.SEc_resnet34(backbone_pretrained=True,
    ...
    actor = actors.SEc_Actor(net=net, objective=objective)
