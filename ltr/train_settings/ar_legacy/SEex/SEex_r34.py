...
import ltr.models.ar_legacy.SEex.SEex_r34 as SEx


def run(settings):
    # Most common settings are assigned in the settings struct
    settings.description = 'Settings of SEem module (e for extreme)'
    ...
    dataset_train = SEsampler.SEMaskSampler(
        [lasot_train, got_10k_train, coco_train, imagenet_vid, imagenet_det, youtube_vos, saliency],
        [1, 1, 1, 1, 1, 2, 3],
    ...
    # Create network
    net = SEx.SEex_resnet34(backbone_pretrained=True,
