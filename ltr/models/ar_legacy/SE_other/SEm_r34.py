...
class SEcmnet(nn.Module):
    ...
    def forward_test(self, test_imgs, mode='train', branches=['mask']):
...
@model_constructor
def SEm_resnet34(backbone_pretrained=True, used_layers=('layer3',), pool_size=None, unfreeze_layer3=False):
    # backbone
