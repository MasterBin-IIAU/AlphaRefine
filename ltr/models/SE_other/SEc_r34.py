...
class SEcmnet(nn.Module):
    ...
    def __init__(self, feature_extractor, neck_module, head_module, used_layers,
        ...
        self.corner_head, _ = head_module
...
@model_constructor
def SEc_resnet34(backbone_pretrained=True, used_layers=('layer3',), pool_size=None, unfreeze_layer3=False):
    # backbone
