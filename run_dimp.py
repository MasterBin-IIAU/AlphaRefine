...
def track_images(get_init_box, get_new_frame, model_path, data_path, save_res):
...
def track_video(get_init_box, model_path, video_path, save_res):
...
if __name__ == '__main__':
    ...
    if os.path.isfile(args.dataset_path):
        track_video(get_init_box, args.model_path, args.dataset_path, vis_video)
    else:
        track_images(get_init_box, get_new_frame, args.model_path, args.dataset_path, save_bb)
