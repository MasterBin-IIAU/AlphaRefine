...
if __name__ == "__main__":
    ...
    dataset_path = '/home/masterbin-iiau/Desktop/tracking_datasets/'
    ...
    for num,seq in enumerate(seq_list):
        ...
        iou_result, result_bb, fps, result_nobb = run_mdnet(img_list, gt[0], gt, seq = seq, savefig_dir='.',display=opts['visualize'])
