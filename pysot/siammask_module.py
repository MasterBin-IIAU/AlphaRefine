...
from pysot.pysot.core.config_new import cfg_new
from pysot.pysot.models.model_builder_new import ModelBuilder
from pysot.pysot.tracker.tracker_builder_new import build_tracker
