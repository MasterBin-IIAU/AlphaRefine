...
from external.pysot.pysot.models.head.rpn import DepthwiseXCorr
from external.pysot.pysot.core.xcorr import xcorr_depthwise
...
class Refine(nn.Module):
    ...
    def forward(self, f, corr_feature, pos):
        '''f[0]是conv1特征,f[1]是layer1特征,f[2]是layer2特征'''
