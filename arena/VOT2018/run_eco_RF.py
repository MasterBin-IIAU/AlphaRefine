...
tracker_name_ = 'eco'
from arena.VOT2018.common_path import *
...
def main(model_code):
    ...
    RF_module = RefineModule(refine_path.format(model_code), selector_path, branches=branches, search_factor=sr, input_sz=input_sz)
