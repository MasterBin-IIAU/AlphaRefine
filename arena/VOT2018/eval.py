...
from pysot.toolkit.visualization import draw_success_precision, draw_eao, draw_f1
import numpy as np
from arena.VOT2018.common_path import save_dir, dataset_root_
...
parser.add_argument('--dataset', '-d', type=str,
                    help='dataset name', default='VOT2018')
