...
run_training.py ${Name1} ${Name2} \
--pretrained=/home/zxy/Desktop/AR_Maintaince/AlphaRefine/ltr/checkpoints/ltr/SEx_beta/SEcmnet_ep0040-c.pth.tar
...
def run_training(train_module, train_name, cudnn_benchmark=True, local_rank=-1, pretrained=None):
    ...
    settings.project_path = 'alpha/{}/{}'.format(train_module, train_name)
    settings.local_rank = local_rank
    settings.device = local_rank
    settings.pretrained = pretrained

    expr_module = importlib.import_module('alpha.{}.{}.train'.format(train_module, train_name))
