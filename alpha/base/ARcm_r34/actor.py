...
class SEcm_Actor(BaseActor):
    ...
    def __call__(self, data):
        ...
        if isinstance(loss_corner, tuple):
            loss_corner, iou_corner = loss_corner[0], loss_corner[1].item()
            mask_weight = 1
        else:
            mask_weight = 1000
            iou_corner = -1
        ...
        if num_mask_sample > 0:
            ...
            loss = 1 * loss_corner + mask_weight * loss_mask
        else:
